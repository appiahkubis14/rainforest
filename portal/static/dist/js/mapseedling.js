...
// ////////////////////////////////////////////////////
    ...
    var farmmap
    farmMap('/api/surveys/boundaries/', newfarm, farm_onEachFeature,farmmap)
    ...
    <div class="beneficiary-popup">
        <div class="beneficiary-card">
            <div class="beneficiary-header">
                <h2>${feature.properties.farmer_name}</h2>
            </div>
            ...
            <div class="beneficiary-info">
                <div class="info-row">
                    ...
                    <div class="info-value">${feature.properties.farmer_id || 'N/A'}</div>
                </div>

                <div class="info-row">
                    <div class="info-label">Community</div>
                    <div class="info-value">${feature.properties.community || 'N/A'}</div>
                </div>

                <div class="info-row">
                    <div class="info-label">Total Seedling Alive</div>
                    <div class="info-value">${feature.properties.total_seedlings_alive || 'N/A'}</div>
                </div>

                <div class="info-row">
                    <div class="info-label">Plantation Type</div>
                    <div class="info-value">${feature.properties.plantation_type || 'N/A'}</div>
                </div>
                ...
                ` : `
                <div class="info-row">
                    <div class="info-label">No. Species</div>
                    <div class="info-value">${feature.properties.species_count || 'N/A'}</div>
                </div>
                `}
            </div>
        </div>
