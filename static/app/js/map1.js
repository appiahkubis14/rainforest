var mymap = L.map('mapid').setView([6.088, -2.063], 9);
...
function highlightFeature(e) {
   ...
   function onEachtreepoints(feature, layer) {
       ...
       layer.bindTooltip('</b>Species:<b>' + feature.properties.species, {
            direction: 'auto'
        })
...
// ////////////////////////////////////////////////////
    ...
    farmMap('/farmboundarylayer/', newfarm, farm_onEachFeature)
    ...
    var farmmap
    function farmMap(url, mnh, oneach) {
        // removela(map, regmap)
    ...
    function district_onEachFeature(feature, layer) {
        ...
        labeltoshow = '<div id="regdetails"> </div>'
...
$.get("/treelayer/",function(data){
    ...
    tree = L.geoJSON(data, {
            pointToLayer: function(feature, latlng) {
                baseballIcon = L.icon({iconUrl:'/static/app/img/tree.png' ,iconSize: [50,30]});
